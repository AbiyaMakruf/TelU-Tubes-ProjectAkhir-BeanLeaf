...
@keras_export(
    [
        "keras.applications.efficientnet_v2.EfficientNetV2B0Modifikasi",
        "keras.applications.EfficientNetV2B0Modifikasi",
    ]
)
def EfficientNetV2B0Modifikasi(
    include_top=True,
    weights="imagenet",
    input_tensor=None,
    input_shape=None,
...
@keras_export(
    [
        "keras.applications.efficientnet_v2.EfficientNetV2B1Modifikasi",
        "keras.applications.EfficientNetV2B1Modifikasi",
    ]
)
def EfficientNetV2B1Modifikasi(
    include_top=True,
    weights="imagenet",
    input_tensor=None,
    input_shape=None,
...
@keras_export(
    [
        "keras.applications.efficientnet_v2.EfficientNetV2B2Modifikasi",
        "keras.applications.EfficientNetV2B2Modifikasi",
    ]
)
def EfficientNetV2B2Modifikasi(
    include_top=True,
    weights="imagenet",
    input_tensor=None,
    input_shape=None,
...
@keras_export(
    [
        "keras.applications.efficientnet_v2.EfficientNetV2B3Modifikasi",
        "keras.applications.EfficientNetV2B3Modifikasi",
    ]
)
def EfficientNetV2B3Modifikasi(
    include_top=True,
    weights="imagenet",
    input_tensor=None,
    input_shape=None,
...
EfficientNetV2B0Modifikasi.__doc__ = BASE_DOCSTRING.format(name="EfficientNetV2B0Modifikasi")
EfficientNetV2B1Modifikasi.__doc__ = BASE_DOCSTRING.format(name="EfficientNetV2B1Modifikasi")
EfficientNetV2B2Modifikasi.__doc__ = BASE_DOCSTRING.format(name="EfficientNetV2B2Modifikasi")
EfficientNetV2B3Modifikasi.__doc__ = BASE_DOCSTRING.format(name="EfficientNetV2B3Modifikasi")
